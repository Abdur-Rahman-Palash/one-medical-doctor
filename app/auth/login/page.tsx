...
import { 
  Eye, EyeOff, Mail, Lock, Shield, AlertCircle,
  ArrowRight, User, Phone, Calendar
} from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.email && formData.password) {
        // Store login state (in real app, this would be handled by auth system)
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Sign in to your One Medical account
            </p>
          </div>
      ...
      <div className="bg-primary-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Need immediate care or have questions?</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/virtual-care" className="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              <Phone className="w-8 h-8 text-primary-600 mx-auto mb-3" />
              <h4 className="font-semibold text-gray-900 mb-2">Virtual Care</h4>
              <p className="text-gray-600 text-sm">24/7 virtual visits available</p>
            </Link>
            
            <Link href="/find-provider" className="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              <User className="w-8 h-8 text-primary-600 mx-auto mb-3" />
              <h4 className="font-semibold text-gray-900 mb-2">Find a Provider</h4>
              <p className="text-gray-600 text-sm">Search our network of doctors</p>
            </Link>
            ...
            <Link href="/contact" className="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Schedule Visit</h4>
              <p className="text-gray-600 text-sm">Book an appointment</p>
            </Link>
          </div>
        </div>
      </div>
